...
class Routes(
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_hashtag5_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("hashtag/"), DynamicPart("keywords", """[^/]+""",true)))
  )
  private[this] lazy val controllers_HomeController_hashtag5_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:11
    case controllers_HomeController_hashtag5_route(params@_) =>
      call(params.fromPath[String]("keywords", None)) { (keywords) =>
        controllers_HomeController_hashtag5_invoker.call(HomeController_1.hashtag(keywords))
      }
